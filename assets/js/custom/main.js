$(window).on("scroll", function () {
    $(this).scrollTop() > 130 ? $(".navbar-part").addClass("navbar-fixed") : $(".navbar-part").removeClass("navbar-fixed");
}),
    ...
    $(".grid-hori").on("click", function () {
        $(".grid-hori").addClass("active"),
            ...
            $(".grid-verti").on("click", function () {
                $(".grid-verti").addClass("active"), $(".grid-hori").removeClass("active");
            });
    }),
    $(function () {
        $(".nasted-dropdown a").click(function () {
            $(this).next().toggle(), $(".nasted-dropdown li ul:visible").length > 1 && ($(".nasted-dropdown li ul:visible").hide(), $(this).next().show());
        });
    }),
