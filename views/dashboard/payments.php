											...
											<td>
												<div style="text-align:center"  class="dropdown">
													...
													<ul class="dropdown-menu">
													  <li><a href="#" onClick="ApprovedPayment(<?=$payment['id']?>,<?=$payment['user_id']?>)"><i class="fa fa-check"></i>Approve</a></li>
													   <li><a href="#" onClick="RejectPayment(<?=$payment['id']?>,<?=$payment['user_id']?>)"><i class="fa fa-ban"></i>Rejected</a></li>
